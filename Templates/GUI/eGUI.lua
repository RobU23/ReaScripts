...
@about
 ...
 - Usage example script included
@link Forum Thread http://reaper.fm
@version 2.0
@author RobU
@provides 
 [nomain] .
 [main] RobU - eGUI Example.lua
@changelog
 v2.0
 Forked from EUGEN27771 GUI for Lua
 Modularised for import (e.g. local e = require 'eGUI')
...
e.col_orange	= {.73, .45, .16, .50}
e.col_yellow	= {.69, .66, .22, .50}
